...
function mathContent(xopts, mode, body)  /* (xopts : options/options, mode : common/mathkind, body : ?string) -> string */  {
  var body_4066 = (body !== undefined) ? body : "";

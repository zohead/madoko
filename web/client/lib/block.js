...
var rxCellCodeInline = "(?:``(?:[^`]|`(?!`))*``|`(?:[^`]|``)*`)";
var rxCellTexInline1 = "(?:\\$(?!\\{)(?:(?:[^\\\\\\$\\|]|\\\\[\\s\\S])+)\\$)";
var rxCellTexInline2 = "(?:\\$\\{(?:(?:[^\\\\\\$]|\\\\[\\s\\S])+)\\$)";
var rxCellContent = ("(?:\\\\.|" + (rxCellTexInline1 + ("|" + (rxCellTexInline2 + ("|" + (rxCellCodeInline + "|[^\\\\|+]|\\+ *(?![-=]))"))))));
var rxCell = $std_regex.regex(("(?:^ *(?:\\||\\+(?=[-=])))?(" + (rxCellContent + "+(?:[|]+|[+]+(?= *[-=])|$))")), undefined, undefined);
...
function blockSpecial(cap, context)  /* (cap : std/regex/matched, context : blockContext) -> block */  {
  function mkblock(name0, content0, lineno0)  /* (name : string, content : list<string>, lineno : ?int) -> list<string> */  {
    var lineno_10967 = (lineno0 !== undefined) ? lineno0 : lineNo(context);
    if ($std_core.isNil(content0)) {
      return $std_core.Nil;
    }
    else {
      return $std_core._plus__3($std_core.Cons(("~ Begin " + (name0 + (" { line-adjust:0; line:" + ($std_core.show_1(lineno_10967) + " }")))), $std_core.Nil), $std_core._plus__3(content0, $std_core.Cons(("~ End " + name0), $std_core.Nil)));
    }
  }
  function entry(name1, className)  /* (name : string, className : ?string) -> list<string> */  {
    var className_11658 = (className !== undefined) ? className : name1;
    var _x0 = $std_dict._lb__rb__2(metadata(context), name1);
    if (_x0 != null) {
      if (($std_string.trim(_x0.unJust) !== "")){
        return mkblock(className_11658, $std_core.Cons(("&" + (name1 + ";")), $std_core.Nil), undefined);
      }
    }
    return $std_core.Nil;
  }
  ...
  function group(xs, n, acc)  /* forall<a> (xs : list<a>, n : ?int, acc : ?list<a>) -> list<list<a>> */  {
    var n_12322 = (n !== undefined) ? n : 3;
    var acc_12326 = (acc !== undefined) ? acc : xs;
    if (xs == null) {
      return $std_core.Nil;
    }
    else {
      if (acc_12326 == null) {
        ...
        return $std_core.Cons($std_core.take(acc_12326, n_12322), group(xs.tail, n_12322, $std_core.drop(acc_12326, n_12322)));
      }
    }
  }
  ...
  function readInt(name2, $default)  /* (name : string, default : ?int) -> int */  {
    var default_12540 = ($default !== undefined) ? $default : 0;
    var _x0 = $std_dict._lb__rb__2(metadata(context), name2);
    if (_x0 != null) {
      return $std_core.parseIntDefault($std_string.trim(_x0.unJust), default_12540, undefined);
    }
    else {
      return default_12540;
    }
  }
...
function parseBlocks_1(context, src, line)  /* (context : blockContext, src : string, line : ?int) -> list<block> */  {
  var line_19819 = (line !== undefined) ? line : 0;
  if (line_19819 > 0) {
    var bs = parseBlocksAccLine(_copy(context, undefined, undefined, undefined, undefined, undefined, undefined, undefined, line_19819, undefined), $std_core.Nil, line_19819, src);
  }
  else {
